...
// ---------------------------------------------------------------------------
// Megacall GPU prefix-sum compute shader — extracted to ./heapScene/scanKernel.
// HEAP_SCAN_WGSL + SCAN_TILE_SIZE / SCAN_WG_SIZE / SCAN_MAX_RECORDS / TILE_K /
// RECORD_U32 / RECORD_BYTES are imported at the top of this file.
// ---------------------------------------------------------------------------
